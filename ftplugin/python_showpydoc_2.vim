...
"Brief:          show document python2.x in command line
"Authors:        VimPcDes <vimpcdes@163.com>
"Last Change:    8.19.2010 9:35
"Version:        1.0
"
"Usage:          commands:
"                 :Spydoc object
...
"
"Install:        the plugin needs python/dyn, make sure "filetype plugin on".
"                copy python_showpydoc_2.vim to your ftplugin directory
"
"Tip:            this plugin now is just designed for standart python2.x library,
...
if !has('python')
    echo "error: Required vim compiled with +python/dyn"
    finish
endif
